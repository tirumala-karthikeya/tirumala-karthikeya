...
<h1 align="center">Hi there, I'm <span style="color:#6C63FF;">Jaddu Tirumala Karthikeya</span> 👋</h1>
<h3 align="center">Full Stack Developer | Problem Solver | Cloud & Automation Enthusiast</h3>
...
## 🚀 About Me  
I'm a passionate **Full Stack Developer** who enjoys building scalable products, crafting clean UIs, and solving real-world engineering problems.

- 🎓 **CSE Undergrad @ IIIT Kottayam**  
- 💼 Fullstack Developer experience at **Voola**, **CAPTN**, and **Xpectrum AI**  
- ☁️ Exploring **Cloud Deployments, CI/CD, and System Design**  
- 🧠 I love working with **React, Next.js, Node.js, MongoDB, Redis, AWS**  
- 📈 Strong interest in **automation, infra, and real-time applications**  
- 💬 Ask me about: Frontend, Backend, DevOps basics, Cloud, APIs  

---

## 🛠️ Tech Stack  
<p align="center">
  <img src="https://skillicons.dev/icons?i=cpp,js,ts,python,react,nextjs,nodejs,express,mongodb,redis,mysql,firebase,aws,docker,git,github,tailwind,bootstrap" />
</p>
...
A modern job discovery platform blending professional networking with social engagement.

### ⭐ **Doctor Appointment System**
A scalable appointment management portal for patients and doctors.

### ⭐ **QuickCrave – Food Delivery**
Real-time tracking, Stripe payments, restaurant recommendations.

---

## 🏆 Achievements  
- 🧩 Solved **250+ DSA problems** on LeetCode & GFG  
- 🏅 **Letter of Appreciation** from IIITK for BDA 2025 Workshop website  
- 🎖️ **Naukri Young Turks – 98.51 percentile**  
